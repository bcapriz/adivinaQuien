...
class ModoHumanoVsMaquinaTest {
    ...
    void elHumanoGanaAdivinandoElPersonajeDeLaMaquina() {
        ...
        new ModoHumanoVsMaquina(consola, maquinaFija(secretoMaquina, jugadaInocua)).jugar(registro);
    ...
    void laMaquinaGanaAdivinandoEnSuTurno() {
        ...
        new ModoHumanoVsMaquina(consola, maquinaFija(secretoMaquina, maquinaAdivina)).jugar(registro);
    ...
    void laNarracionMuestraLaRespuestaSiONoDelFiltro() {
        ...
        var consola = new ConsolaFake("2", "1", "1", "1"); // humano elige id 2; turno: filtro -> genero -> masculino
